...
| POST | `/sources/{id}/enabled?enabled=` · DELETE `/sources/{id}` | your own switch · remove the row; both 404 for a source not in your list, delete is 409 if someone else follows it and 400 for a seed row |
